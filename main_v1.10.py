...
class onescraper():
    ...
    def navigate_offset(self, location):
        ...
        try:
            facility_btn = WebDriverWait(self.driver, 50).until(
            ...
            logTxt = 'Success:\tClicked facility button'
            self.log_printer.print_log(logTxt)

        except:
            logTxt = 'Error:\tFailed to click facility button'
            self.log_printer.print_log(logTxt)
            self.scrapModel.add_location(location)
            return
        ...
        try:
            ...
            logTxt = 'Success:\tClicked favorite button'
            self.log_printer.print_log(logTxt)
        except:
            logTxt = 'Error:\tFailed to click favorite button'
            self.log_printer.print_log(logTxt)
            self.scrapModel.add_location(location)
            return
